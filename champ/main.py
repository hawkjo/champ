...
Usage:
  ...
  champ init IMAGE_DIRECTORY CHIP_NAME READ_NAMES_DIRECTORY ALIGNMENT_CHANNEL LDA_WEIGHTS [--perfect-target-name=PERFECT_TARGET_NAME] [--fiducial-only] [--alternate-perfect-reads=ALTERNATE_PERFECT_READS] [--alternate-good-reads=ALTERNATE_GOOD_READS] [--microns-per-pixel=0.266666666] [--chip=miseq] [--ports-on-right] [--flipud] [--fliplr] [-v | -vv | -vvv ]
