...
Usage:
  ...
  champ init IMAGE_DIRECTORY CHIP_NAME MAPPED_READS PARSED_READS ALIGNMENT_CHANNEL LDA_WEIGHTS [--alternate-fiducial-reads ALTERNATE_FIDUCIAL_READS] [--perfect-target-name=PERFECT_TARGET_NAME] [--alternate-perfect-reads=ALTERNATE_PERFECT_READS] [--alternate-good-reads=ALTERNATE_GOOD_READS] [--microns-per-pixel=0.266666666] [--chip=miseq] [--ports-on-right] [--flipud] [--fliplr] [-v | -vv | -vvv ]
  champ align IMAGE_DIRECTORY [--fiducial-only] [--min-hits=MIN_HITS] [--snr=SNR] [--make-pdfs] [-v | -vv | -vvv]
