...
Usage:
  champ map FASTQ_DIRECTORY OUTPUT_DIRECTORY [--log-p-file] [--target-sequence-file=TARGET_SEQUENCE_FILE] [--phix-bamfiles] [--bamfiles BAMFILES ...] [--min-len] [--max-len] [--max-ham] [-v | -vv | -vvv]
