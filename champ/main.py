...
Usage:
  champ map FASTQ_DIRECTORY OUTPUT_DIRECTORY [--log-p-file=LOG_P_FILE] [--target-sequence-file=TARGET_SEQUENCE_FILE] [--phix-bamfiles=PHIX_BAMFILES] [--bamfiles BAMFILES ...] [--min-len=MIN_LEN] [--max-len=MAX_LEN] [--max-ham=MAX_HAM] [-v | -vv | -vvv]
