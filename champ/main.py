...
Usage:
  champ map FASTQ_DIRECTORY OUTPUT_DIRECTORY [--log-p-file=LOG_P_FILE] [--target-sequence-file=TARGET_SEQUENCE_FILE] [--phix-bamfiles=PHIX_BAMFILES] [--min-len=MIN_LEN] [--max-len=MAX_LEN] [-v | -vv | -vvv]
  ...
  champ align IMAGE_DIRECTORY [--rotation-adjustment=ROTATION_ADJUSTMENT] [--min-hits=MIN_HITS] [--snr=SNR] [--cores=CORES] [--make-pdfs] [--fiducial-only] [-v | -vv | -vvv]
